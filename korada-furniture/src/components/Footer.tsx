          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-slate-400 text-sm">+91-94483-67202</p>
                  <p className="text-slate-400 text-sm">+91-84310-39089</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-sky-400 flex-shrink-0" />
                <p className="text-slate-400 text-sm">koradafurniture@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
