              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+91-94483-67202 (Balakrishna Kotekar)</p>
                    <p className="text-gray-600">+91-84310-39089 (Chetan Chitragar)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">koradafurniture@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Korada Furniture Co. Pvt. Ltd.<br />
                      Kundgol - Hubli Rd, Kotgondhunsi<br />
                      Karnataka 580024
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="bg-gray-200 rounded-lg h-64 flex items-center justify-center">
                <div className="text-center text-gray-500">
                  ...
                  <p className="text-sm">Kundgol - Hubli Rd, Kotgondhunsi, Karnataka</p>
                </div>
              </div>
            </div>
          </motion.div>
